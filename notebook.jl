...
# ╔═╡ 8a436292-a737-4abb-89c6-c9f59ca913db
begin
	using DataFrames
	using CSV
end

# ╔═╡ fdf40b2f-773c-4bce-9301-35e573a44019
using Plots  # This will install plots

# ╔═╡ 4764b755-508f-4d58-a14b-811d8fa8501f
using PlutoUI

# ╔═╡ bc7b800f-b08d-451e-8966-3ca2525ee092
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 1ab4ca0f-f055-44b3-81d5-f134c8abbd16
df.Country_code === df[!, "Country_code"]

# ╔═╡ 9e1e87ce-4a9a-4e20-a60d-967afa9a4cc3
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 368c06f3-0a4a-4b00-a8e0-d7d6bec751f0
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 50386113-c139-47fe-a85b-5925465e83fb
dates = sg_data[!, "Date_reported"]

# ╔═╡ cce870c4-002f-4547-a750-a0e35a421b6b
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 4b33708a-8e89-4238-8eb5-a38c845dc0ea
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ cf999875-2199-449d-8a4c-d93a208c316d
...
# ╔═╡ 1ac2987d-f141-4908-abbc-7b2b01f64008
@bind slider_value Slider(0:10:1000)

# ╔═╡ 04b6ab5e-21e5-441d-924c-7e14c5c96751
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 45fb63b4-5d33-4bca-a10a-b80b4052d2d1
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 8b1a9690-b8cf-48a8-8040-1efdf4691d10
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 858481cc-d77e-4fab-8896-59d67d840ee4
